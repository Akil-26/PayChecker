...
class HealthResponse(BaseModel):
    """Service liveness, dependency health, and current clock time."""
    ...
    virtual_clock_time: datetime = Field(
        description="Current clock time (UTC in production, virtual in development)."
    )
    db_status: str = Field(default="ok", description="'ok' or 'unreachable'")
