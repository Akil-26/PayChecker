"""Seed the Paychecker database with synthetic demonstration data.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Seed synthetic Paychecker data.")
    ...
    with session_scope() as session:
        ...
        print()
        print("=" * 74)
        print("  PAYCHECKER  |  SYNTHETIC DEMONSTRATION DATA SEEDED")
        print("=" * 74)
